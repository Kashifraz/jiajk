...
$total_unioncouncils = $constituency->unioncouncil->count();
@endphp
                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        ?> flex items-center  justify-center bg-white rounded-lg overflow-hidden shadow-md">
                                <div class="p-2 text-gray-700 text-center">
                                    <h3 class="text-md font-bold tracking-wider hover:underline mb-1"><a href="{{route('unioncouncil.show', $unioncouncil->id)}}"> {{$unioncouncil->union_council_title}}</a> </h3>
                                    <div class="bg-white  rounded-lg text-gray-700">
                                        <p class=" p-2 "> <b>Total Profiles: </b> {{$user_count }} 
                                        <a href="<?php echo url('/show/members?destrict='.$constituency->affiliation->id.'&constituency='.$constituency->id.'&unioncouncil='.$unioncouncil->id.'') ?>"><i class="fa-solid fa-eye mx-2"></i></a> </p></p>
                                    </div>
